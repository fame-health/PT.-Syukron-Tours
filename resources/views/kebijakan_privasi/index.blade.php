  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-20 items-center">
      ...
      <div class="hidden md:flex space-x-8" id="desktopMenu">
        ...
        <a href="/kebijakan-privasi" class="nav-link relative text-yellow-600 font-semibold transition-colors duration-300 group">
    ...
    <section id="kebijakan-privasi" class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-16 fade-in">
                ...
                <h2
                    class="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-800 to-blue-600 bg-clip-text text-transparent">
                    Kebijakan Privasi
                </h2>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-lg p-8 fade-in">
                        ...
                        <div id="perlindungan-data" class="mb-12">
                            ...
                            <div
                                class="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 p-6 rounded-xl">
                                <div class="flex items-center mb-4">
                                    <i class="fas fa-exclamation-triangle text-red-600 text-xl mr-3"></i>
                                    <h4 class="font-semibold text-gray-800">Keamanan Tinggi</h4>
                                </div>
                                <p class="text-gray-700 mb-4">
                                    Kami menggunakan teknologi enkripsi terdepan dan protokol keamanan berlapis untuk
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        ...
                                        <p class="text-sm text-gray-600">Hanya staf terotorisasi yang dapat mengakses
                                        </p>
                                    </div>
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        <div class="flex items-center mb-2">
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Hotel, maskapai, dan operator tur
                                                    untuk keperluan perjalanan umroh</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Instansi pemerintah atau penegak hukum
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Pencegahan penipuan dan aktivitas
                                                    ilegal</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div
                                    ...
                                    <p class="text-gray-700 text-sm">
                                        Hak untuk mengakses dan mendapatkan salinan data pribadi yang kami simpan
                                        tentang Anda.
                                    </p>
                                </div>
                                ...
                                <div
                                    ...
                                    <p class="text-gray-700 text-sm">
                                        Hak untuk meminta perbaikan atau pembaruan data yang tidak akurat atau tidak
                                        lengkap.
                                    </p>
                                </div>
                                ...
                                <div
                                    ...
                                    <p class="text-gray-700 text-sm">
                                        Hak untuk meminta penghapusan data pribadi dalam kondisi tertentu yang diizinkan
                                        hukum.
                                    </p>
                                </div>
                        ...
                        <div id="kontak-privasi" class="mb-8">
                            ...
                            <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl">
                                ...
                                <div class="mt-8 text-center">
                                    <a href="mailto:privacy@mudarismandiri.com"
                                        class="inline-flex items-center justify-center px-6 py-3 bg-white text-blue-600 font-semibold rounded-full hover:bg-gray-100 transition-colors">
