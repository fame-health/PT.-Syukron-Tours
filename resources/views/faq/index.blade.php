...
<nav class="glass-morphism fixed w-full z-50 top-0 transition-all duration-300" id="navbar">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-20 items-center">
      ...
      <div class="hidden md:flex space-x-8" id="desktopMenu">
        ...
        <a href="/faq" class="nav-link relative text-yellow-600 font-semibold transition-colors duration-300 group">
          FAQ
  ...
  <div id="mobile-menu" class="md:hidden hidden glass-morphism absolute top-20 left-0 right-0 w-full z-50">
    <div class="px-4 pt-2 pb-6 space-y-4 bg-white shadow-md rounded-b-xl">
      ...
      <a href="/faq" class="block py-3 px-4 text-yellow-600 font-semibold bg-yellow-50 rounded-lg">FAQ</a>
        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="space-y-6" id="faqContainer">
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover" data-category="paket">
                    <button
                        class="faq-header w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <h3 class="text-lg font-semibold text-gray-800 pr-4">Berapa lama paket umroh yang tersedia?
                        </h3>
                        <i class="fas fa-chevron-down faq-toggle text-yellow-600 text-lg"></i>
                    </button>
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Kami menyediakan berbagai paket umroh mulai dari 9 hari hingga 14 hari dengan pilihan hotel
                            3-5 bintang.
                            Setiap paket dirancang sesuai kebutuhan dan budget jamaah, termasuk paket keluarga, VIP, dan
                            reguler.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover" data-category="umum">
                    ...
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Ya, kami memberikan garansi keberangkatan 100% untuk semua paket yang telah dibayar lunas
                            sesuai dengan
                            jadwal yang telah ditentukan. Jika terjadi pembatalan dari pihak kami, dana akan
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover"
                    data-category="pembayaran">
                    <button
                        class="faq-header w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <h3 class="text-lg font-semibold text-gray-800 pr-4">Bagaimana sistem pembayaran paket umroh?
                        </h3>
                        <i class="fas fa-chevron-down faq-toggle text-yellow-600 text-lg"></i>
                    </button>
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Kami menyediakan sistem pembayaran yang fleksibel. Jamaah dapat melakukan pembayaran secara
                            tunai,
                            transfer bank, atau cicilan. Untuk cicilan, tersedia pilihan 3, 6, atau 12 bulan dengan
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover" data-category="paket">
                    <button
                        class="faq-header w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <h3 class="text-lg font-semibold text-gray-800 pr-4">Apa saja yang termasuk dalam paket umroh?
                        </h3>
                        <i class="fas fa-chevron-down faq-toggle text-yellow-600 text-lg"></i>
                    </button>
                    <div class="faq-content px-8 pb-6">
                        ...
                        <ul class="text-gray-600 space-y-2 ml-4">
                            <li class="flex items-start"><i class="fas fa-check text-green-500 mr-2 mt-1"></i>Tiket
                                pesawat PP Jakarta-Jeddah/Madinah</li>
                            <li class="flex items-start"><i
                                    class="fas fa-check text-green-500 mr-2 mt-1"></i>Akomodasi hotel 3-5 bintang</li>
                            <li class="flex items-start"><i
                                    class="fas fa-check text-green-500 mr-2 mt-1"></i>Transportasi AC selama di Arab
                                Saudi</li>
                            <li class="flex items-start"><i class="fas fa-check text-green-500 mr-2 mt-1"></i>Makan 3x
                                sehari</li>
                            <li class="flex items-start"><i
                                    class="fas fa-check text-green-500 mr-2 mt-1"></i>Bimbingan ibadah lengkap</li>
                            <li class="flex items-start"><i class="fas fa-check text-green-500 mr-2 mt-1"></i>Visa
                                umroh</li>
                            <li class="flex items-start"><i class="fas fa-check text-green-500 mr-2 mt-1"></i>Asuransi
                                perjalanan</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover" data-category="umum">
                    ...
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Untuk jamaah dewasa, minimal berusia 18 tahun dan maksimal 75 tahun. Untuk anak-anak,
                            minimal 2 tahun
                            dengan pendampingan orang tua. Jamaah yang berusia di atas 75 tahun harus melampirkan surat
                            keterangan
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover"
                    ...
                    <button
                        class="faq-header w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <h3 class="text-lg font-semibold text-gray-800 pr-4">Apakah bisa refund jika batal berangkat?
                        </h3>
                        <i class="fas fa-chevron-down faq-toggle text-yellow-600 text-lg"></i>
                    </button>
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Kebijakan refund tergantung pada waktu pembatalan. Jika pembatalan dilakukan lebih dari 60
                            hari sebelum
                            keberangkatan, dana akan dikembalikan 80%. Kurang dari 60 hari, akan dikenakan biaya
                            administrasi sesuai
                ...
                <div class="faq-item bg-white rounded-2xl shadow-lg overflow-hidden card-hover" data-category="paket">
                    <button
                        class="faq-header w-full px-8 py-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <h3 class="text-lg font-semibold text-gray-800 pr-4">Berapa jarak hotel dari Masjidil Haram dan
                            Masjid Nabawi?</h3>
                        <i class="fas fa-chevron-down faq-toggle text-yellow-600 text-lg"></i>
                    </button>
                    <div class="faq-content px-8 pb-6">
                        <p class="text-gray-600 leading-relaxed">
                            Untuk paket reguler, jarak hotel sekitar 500-800 meter dari Masjidil Haram dan Masjid
                            Nabawi.
                            Paket VIP menawarkan hotel dengan jarak 200-400 meter. Semua hotel sudah terkoneksi dengan
                            shuttle bus
                ...
                header.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('.faq-item').forEach(otherItem => {
                        if (otherItem !== item) {
                            ...
                            otherItem.querySelector('.faq-toggle').classList.remove(
                                'fa-chevron-up');
                            otherItem.querySelector('.faq-toggle').classList.add(
                                'fa-chevron-down');
                        }
                    });
