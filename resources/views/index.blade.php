...
<head>
    ...
    <meta name="keywords"
        content="paket umroh, umroh murah, travel umroh terpercaya, paket umroh 2025, umroh keluarga, umroh VIP, agen umroh resmi, Syukron Tours, umroh jakarta, biaya umroh">
    ...
    <meta name="apple-mobile-web-app-title" content="Syukron Tours">
    ...
    <script type="application/ld+json">
  {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Paket Umroh Syukron Tours",
      "itemListElement": [
        {
          "@type": "Offer",
          "itemOffered": {
    ...
    <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Apakah Syukron Tours sudah berizin resmi?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Ya, Syukron Tours telah berizin resmi dan berpengalaman lebih dari 15 tahun dalam melayani jamaah umroh."
        }
      },
      {
        "@type": "Question",
    ...
    <section id="galeri" class="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-xl text-gray-600">Dokumentasi perjalanan jamaah bersama Syukron Tours</p>
            </div>
                        ...
                        <div class="relative w-full aspect-[9/16] bg-gray-100 overflow-hidden">
                            @if ($media->type === 'poster')
                                ...
                                <img src="{{ $media->image_url ?? 'https://via.placeholder.com/400x320?text=Poster+Rahmah+Travel' }}"
                                    alt="{{ $media->alt_text ?? 'Poster Syukron Tours' }}"
                                    class="w-full h-full object-cover" />
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        function showAlert(type, message) {
                            alertMessage.className =
                                `mb-4 p-4 rounded-xl ${type === 'success' ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-red-100 text-red-700 border border-red-200'}`;
