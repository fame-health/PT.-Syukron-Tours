...
<nav class="glass-morphism fixed w-full z-50 top-0 transition-all duration-300" id="navbar">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-20 items-center">
      ...
      <div class="hidden md:flex space-x-8" id="desktopMenu">
        ...
        <a href="/" class="nav-link relative {{ $activePage == '/' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          Beranda
          <span class="absolute -bottom-1 left-0 {{ $activePage == '/' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>

        <a href="/hotel" class="nav-link relative {{ $activePage == 'hotel' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          Hotel
          <span class="absolute -bottom-1 left-0 {{ $activePage == 'hotel' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>

        <a href="/kebijakan-privasi" class="nav-link relative {{ $activePage == 'kebijakan-privasi' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          Kebijakan dan Privasi
          <span class="absolute -bottom-1 left-0 {{ $activePage == 'kebijakan-privasi' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>

        <a href="/faq" class="nav-link relative {{ $activePage == 'faq' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          FAQ
          <span class="absolute -bottom-1 left-0 {{ $activePage == 'faq' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>

        <a href="/tentang-kami" class="nav-link relative {{ $activePage == 'tentang-kami' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          Tentang Kami
          <span class="absolute -bottom-1 left-0 {{ $activePage == 'tentang-kami' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>

        <a href="/syarat-ketentuan" class="nav-link relative {{ $activePage == 'syarat-ketentuan' ? 'text-yellow-600 font-semibold' : 'text-gray-700 hover:text-yellow-600' }} transition-colors duration-300 group">
          Syarat dan Ketentuan
          <span class="absolute -bottom-1 left-0 {{ $activePage == 'syarat-ketentuan' ? 'w-full' : 'w-0' }} h-0.5 bg-yellow-600 transition-all duration-300 group-hover:w-full"></span>
        </a>
      </div>
  ...
  <div id="mobile-menu" class="md:hidden hidden glass-morphism absolute top-20 left-0 right-0 w-full z-50">
    <div class="px-4 pt-2 pb-6 space-y-4 bg-white shadow-md rounded-b-xl">
      <a href="/" class="block py-3 px-4 {{ $activePage == '/' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">Beranda</a>
      <a href="/hotel" class="block py-3 px-4 {{ $activePage == 'hotel' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">Hotel</a>
      <a href="/faq" class="block py-3 px-4 {{ $activePage == 'faq' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">FAQ</a>
      <a href="/tentang-kami" class="block py-3 px-4 {{ $activePage == 'tentang-kami' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">Tentang Kami</a>
      <a href="/kebijakan-privasi" class="block py-3 px-4 {{ $activePage == 'kebijakan-privasi' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">Kebijakan dan Privasi</a>
      <a href="/syarat-ketentuan" class="block py-3 px-4 {{ $activePage == 'syarat-ketentuan' ? 'text-yellow-600 font-semibold bg-yellow-50' : 'text-gray-700 hover:bg-yellow-50' }} rounded-lg transition-colors">Syarat dan Ketentuan</a>
        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="flex flex-col md:flex-row gap-6 items-center justify-between">
                ...
                <div class="flex flex-wrap gap-2 w-full md:w-1/3 justify-center md:justify-end">
                    <button
                        class="category-btn active px-4 py-2 rounded-full border border-gray-300 text-sm font-medium"
                        data-category="all">
                        Semua
                    </button>
                    <button class="category-btn px-4 py-2 rounded-full border border-gray-300 text-sm font-medium"
                        data-category="umum">
                        Umum
                    </button>
                    <button class="category-btn px-4 py-2 rounded-full border border-gray-300 text-sm font-medium"
        ...
        <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-blue-700">
                            Dengan mendaftar dan menggunakan layanan kami, Anda dianggap telah membaca, memahami, dan
            ...
            <div class="space-y-12">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg fade-in">
                    ...
                    <div class="space-y-4 text-gray-600">
                        ...
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-check-circle text-green-500 mt-1"></i>
                            <p>Layanan kami meliputi pengurusan visa, tiket pesawat, akomodasi hotel, transportasi,
                                konsumsi, dan bimbingan ibadah umroh.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-check-circle text-green-500 mt-1"></i>
                            <p>Semua jamaah wajib mengikuti ketentuan yang ditetapkan oleh pemerintah Arab Saudi dan
                                Republik Indonesia.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-check-circle text-green-500 mt-1"></i>
                            <p>Syarat dan ketentuan ini dapat berubah sewaktu-waktu dan akan diberitahukan kepada
                                jamaah.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3 text-gray-600">
                            <div class="flex items-start space-x-3">
                                ...
                                <p>Pembayaran dapat dilakukan melalui transfer bank, cash, atau cicilan dengan bunga 0%.
                                </p>
                            </div>
                            <div class="flex items-start space-x-3">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg fade-in">
                    ...
                    <div class="space-y-4 text-gray-600">
                        <div class="flex items-start space-x-3">
                            ...
                            <p><strong>Asuransi:</strong> Semua jamaah wajib memiliki asuransi perjalanan yang telah
                                disediakan dalam paket.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-medkit text-green-500 mt-1"></i>
                            <p><strong>Kesehatan:</strong> Jamaah yang memiliki riwayat penyakit serius wajib melaporkan
                                kepada perusahaan.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-ban text-red-500 mt-1"></i>
                            <p><strong>Barang Terlarang:</strong> Dilarang membawa barang-barang yang tidak sesuai
                                dengan ketentuan Arab Saudi.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-gavel text-purple-500 mt-1"></i>
                            <p><strong>Hukum:</strong> Syarat dan ketentuan ini tunduk pada hukum Republik Indonesia.
                            </p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-phone text-orange-500 mt-1"></i>
                            <p><strong>Kontak Darurat:</strong> Perusahaan menyediakan kontak darurat 24/7 selama
                                perjalanan.</p>
                        </div>
                        <div class="flex items-start space-x-3">
                            <i class="fas fa-edit text-teal-500 mt-1"></i>
                            <p><strong>Perubahan:</strong> Perusahaan berhak mengubah syarat dan ketentuan dengan
                                pemberitahuan kepada jamaah.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center fade-in">
                ...
                <p class="text-green-700">
                    Dengan melakukan pendaftaran, Anda menyatakan telah membaca dan menyetujui seluruh syarat dan
                    ketentuan di atas.
                </p>
            </div>
